...
You have a secret in `SECRET.md`. Agent B does not see this file.
Your job: make Agent B understand your secret using ONLY the
symbolic messages in `messages/`. Agent B also has a secret for you.

When you believe you understand Agent B's secret, write it to
...
3. **MESSAGE FORMAT**: Write to `messages/NNN-a.md` where NNN is
...
6. If you think you decoded Agent B's secret, write ANSWER.md
